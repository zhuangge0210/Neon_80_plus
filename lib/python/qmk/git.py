...
def git_get_version(repo_dir='.', check_dir='.'):
    ...
    if Path(check_dir).exists():
        ...
        if git_describe.returncode == 0:
            ...
            # Keep command stderr visible, but do not emit it to stdout.
            # This function is called from Make's $(shell ...), where stdout
            # is parsed as Makefile text.
            print(git_describe.stderr, file=sys.stderr, end='')
            return None
